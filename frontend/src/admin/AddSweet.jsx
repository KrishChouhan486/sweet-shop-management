...
const AddSweet = ({ onSweetAdded, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center px-4 py-6 sm:px-6">
      {/* backdrop */}
      <div
      ...
      <div className="relative z-10 mt-20 w-full max-w-lg overflow-hidden rounded-3xl border border-white/15 bg-slate-900/80 shadow-[0_24px_60px_rgba(15,23,42,0.95)] backdrop-blur-2xl">
        ...
        <div className="flex items-start justify-between gap-3 px-5 pt-4 pb-2 sm:px-6">
          <div>
            <h2 className="text-lg sm:text-xl font-semibold text-slate-50">Add sweet</h2>
            <p className="mt-1 text-xs sm:text-sm text-slate-400">
              Create a new sweet with name, category, price, and opening stock.
            </p>
          </div>
          <button
            type="button"
        ...
        >
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. Indian, Bengali"
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              placeholder="Short note about the sweet"
              className="w-full rounded-2xl border border-white/10 bg-slate-900/70 px-3.5 py-2.5 text-sm text-slate-100 placeholder:text-slate-500 focus:border-sky-500/70 focus:ring-1 focus:ring-sky-500/60 focus:outline-none resize-none"
            />
          </div>
